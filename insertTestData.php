...
$connection = mysqli_connect("localhost", "root", "password", "GroupUpDebug");
...
$testData = 'INSERT INTO `GroupUpDebug`.`Admin`
(`email`,
`password`,
`firstName`,
`lastName`,
...
if (mysqli_multi_query($connection, $testData)) {
	echo "Test data inserted successfully" . "\n";
} else {
	echo "Error inserting test data: " . mysqli_error($connection);
}
?>